...
<div class="main-content mb-1">
  ...
  <div class="content-wrapper">
    <div class="content-header mr-2">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="col-sm-6 ml-5">Laporan Perorang</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <form action="?m=printt" target="_blank" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                <div class="form-control">
                  <select class="select2" name="nama_user" id="id_tahun" class="form-control" require>
                    <?php
                    $Que = "select user.* from user where status='guru' or status='Kepsek'";
                    $myQry = mysqli_query($koneksi, $Que) or die("Gagal Query sub Gudang " . mysqli_error($koneksi));
                    while ($hasil = mysqli_fetch_array($myQry)) {
                      echo "<option value='$hasil[nama_lengkap]' >
                    $hasil[nama_lengkap]
                    </option>";
                    }
                    ?>
          ...
          <div class="col-sm-4">
            <button type="submit" id="search" name="find" class="btn btn-success ml-3">PRINT atas Nama</button>
          </div>
        </div>
        </form>
      </div>
