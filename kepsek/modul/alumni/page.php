...
<div class="main-content mb-1">
  ...
  <div class="content-wrapper">
    <div class="content-header mr-2">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="col-sm-6 ml-5">Data Alumni</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12"><br>
            <form action="?m=cetakalumni" target="_blank" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-2 ml-5">
                  <div class="form-group">
                    <select name="tahun" id="id_tahun" class="form-control ml-2" require="">
                      <?php
                      $Que = "select * from  alumni join kelas on alumni.tahun_lulus=kelas.id_kelas group by tahun_lulus";
