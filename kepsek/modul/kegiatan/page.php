...
<div class="main-content mb-1">
  ...
  <div class="content-wrapper">
    <div class="content-header mr-2">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="col-sm-6 ml-5">Data Kegiatan</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
                  ...
                  <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" autocomplete="off" name="nama_kegiatan">
                      </div>

                      <div class="form-group">
                        <label>Point</label>
                        <input type="text" class="form-control" autocomplete="off" name="point">
                      </div>
