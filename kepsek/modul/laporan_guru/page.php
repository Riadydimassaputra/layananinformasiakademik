  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
        <div class="col-sm-2">
                        <form action="?m=jurnall" target="_blank" method="POST" enctype="multipart/form-data">
                            <div class="col-sm-10">
                    ...
                    <div class="col-sm-3">
                        <button type="submit" id="search" name="go" class="btn btn-success ml-3">PRINT</button>
                    </div>
                    </form>
                </div>
            </div>
