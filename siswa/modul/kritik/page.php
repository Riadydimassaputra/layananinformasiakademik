                  ...
                  <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        <label>Kotak Kritik dan Saran :</label>
                        <textarea class="form-control" rows="15" cols="100" autocomplete="off" name="kritik" required></textarea>
                      </div>

                      <input type="text" class="form-control" autocomplete="off" name="tahun" value="<?php echo date('Y'); ?>" hidden>
