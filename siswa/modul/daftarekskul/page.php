        ...
        <div class="row">
          <div class="col-sm-12"><br>
            <div class="col-sm-6 ml-5">
              ...
              <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#datamanual">
                Tambah Data
              </button>
            </div>
            <br>
                  ...
                  <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        <label>Nama : </label>
                        <input type="text" class="form-control" autocomplete="off" name="nama_siswa" value="<?= $adm['nama_lengkap']; ?>" readonly>
                      </div>

                      <div class="form-group">
                        <label>Daftar Ekstrakurikuler</label>
