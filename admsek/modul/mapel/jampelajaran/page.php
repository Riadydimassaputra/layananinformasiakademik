...
<div class="main-content mb-1">
  ...
  <div class="content-wrapper">
    <div class="content-header mr-2">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="col-sm-6 ml-5">Data Jam Pelajaran</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
              ...
              <div class="row mb-2">
                <div class="col-sm-6 ml-5">
                  <div class="form-group">
                    <input type="text" placeholder="Masukan Hari" name="cari" autocomplete="off" class="form-control" value="">
                  </div>
                </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        <label>Hari :</label>
                        <input type="text" class="form-control" autocomplete="off" name="nama_hari" required>
                      </div>

                      <div class="form-group">
                        <label>Waktu Awal : </label>
                        <input type="text" class="form-control" autocomplete="off" name="waktu_awal" required>
                      </div>

                      <div class="form-group">
                        <label>Waktu Akhir : </label>
                        <input type="text" class="form-control" autocomplete="off" name="waktu_akhir" required>
                      </div>
              ...
              <ul class="pagination justify-content-center">
                <li class="page-item">
                  <a class="page-link" <?php if ($halaman > 1) {
                                          echo "href='?m=hari&halaman=$previous'";
                                        } ?>>Previous</a>
                </li>
                <?php
                for ($x = 1; $x <= $total_halaman; $x++) {
                ?>
                  <li class="page-item"><a class="page-link" href="?m=hari&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                <?php
                }
                ?>
                <li class="page-item">
                  <a class="page-link" <?php if ($halaman < $total_halaman) {
                                          echo "href='?m=hari&halaman=$next'";
                                        } ?>>Next</a>
                </li>
              </ul>
            </center>
