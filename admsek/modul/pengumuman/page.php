...
<div class="main-content mb-1">
  ...
  <div class="content-wrapper">
    <div class="content-header mr-2">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="col-sm-6 ml-5">Data Pengumuman</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
                  ...
                  <div class="modal-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" autocomplete="off" name="nama_pengumuman" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" autocomplete="off" name="keterangan" required></textarea>
                      </div>

                      <div class="form-group">
                        <label>Gambar Pengumuman : </label>
                        <input type="file" class="form-control" autocomplete="off" name="isi" required>
                      </div>
