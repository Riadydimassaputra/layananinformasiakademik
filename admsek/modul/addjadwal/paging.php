...
$data = mysqli_query($koneksi, "SELECT * FROM jadwalmapel");
...
if (isset($_POST['find'])) {
  $cari = $_POST['cari'];
  $siswa = mysqli_query($koneksi, "SELECT * from jadwalmapel WHERE hari LIKE '%" . $cari . "%'");
} else {
  $siswa = mysqli_query($koneksi, "SELECT * from jadwalmapel LIMIT $halaman_awal, $batas");
}
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id_ekskul" value="<?= $pro['id_jadwalmapel']; ?>" hidden>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="" method="POST">
                <input type="hidden" hidden name="id_ekskul" value="<?= $pro['id_jadwalmapel']; ?>">
