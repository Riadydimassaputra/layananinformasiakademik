...
<div class="main-content mb-1">
    ...
    <div class="content-wrapper">
        <div class="content-header mr-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="col-sm-6 ml-5">Data Pembayaran Cicilan Register</h3>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row mb-3">
                <div class="col-sm-2 ml-5">
                    <form action="?m=priint" target="_blank" method="POST" enctype="multipart/form-data">
