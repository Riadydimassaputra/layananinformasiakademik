	...
	<body>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<h2>
					<center>LAPORAN DAFTAR SISWA YANG TELAH BAYAR SPP DENGAN CARA CICILAN </center>
				</h2><br>
				<div class="col-sm-2">
					<table border="1" style="width: 1400px">
						...
						$ftahun = $_POST['tahun'];
						$cari = $_POST['cari'];
						$siswa = mysqli_query($koneksi, "SELECT * from bayar where tahun='$ftahun' AND bulan='$cari' AND status='Cicilan' and kategoripem like 'SPP%'");
				...
				<h3 style="text-align: right;">Total yang DiTerima Bulan Ini Rp. <?= number_format($total, 0, ',', '.'); ?></h3>
				<hr>
