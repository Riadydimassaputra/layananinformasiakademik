    ...
    <body>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h2>
                    <center>HISTORI PEMBAYARAN BIAYA PENDIDIKAN </center>
                </h2><br>
                ...
                <div class="col-sm-2">
                    <table border="1" style="width: 1400px">
                        ...
                        $NIS = $_POST['NIS'];
                        $cari = $_POST['jenispem'];
                        $siswa = mysqli_query($koneksi, "SELECT * FROM tagihan inner join siswa on tagihan.NIS=siswa.NIS INNER JOIN kelas on siswa.id_kls=kelas.id_kelas where tagihan.NIS='$NIS' AND jenispem='$cari'");
                        ...
                        foreach ($siswa as $pro) : ?>
                            <tr>
                                ...
                                <td>
                                    <center><?= $pro['NIS']; ?> - <?= $pro['nama_siswa']; ?></center>
                                </td>
                                <td>
                                ...
                                <td>
                                    <center><?= $pro['tanggal_bayar']; ?></center>
                                </td>
                                <td>
                ...
                <h3>Total yang sudah Di Bayarkan SEMESTER ini Sebesar Rp. <?= number_format($total, 0, ',', '.'); ?></h3><br>
                <hr>
                <h3>Tagihan yang Harus Di Bayarkan SEMESTER ini Sebesar Rp. <?= number_format($totals, 0, ',', '.'); ?></h3><br>
                <br>
                <hr>
