...
<body>
	...
	$siswa = mysqli_query($koneksi, "SELECT id_siswa, NIS,nama_siswa,kelas.nama_kelas,jurusan,tahunajaran from siswa inner JOIN kelas on 
	siswa.id_kls=kelas.id_kelas where tahunajaran='$tahun'");
	...
	<div class="row">
		...
		<div class="table-responsive table--no-card m-b-30 ml-5 mr-5">
			<h2>
				<center>LAPORAN DAFTAR SISWA BARU <?php echo $tahun; ?> </center>
			</h2><br>
			<table border="1" style="width: 100%">
				<tr>
					...
					<th>
						<center>KELAS DAN JURUSAN </center>
					</th>
				</tr>
				<?php
