	...
	<body>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<h2>
					<center>LAPORAN DAFTAR SISWA YANG TELAH BAYAR </center>
				</h2><br>
				<div class="col-sm-2">
					<table border="1" style="width: 1400px">
						...
						$ftahun = $_POST['tahun'];
						$cari = $_POST['bulan'];
						$siswa = mysqli_query($koneksi, "SELECT * from bayar where tahun='$ftahun' AND bulan='$cari' AND status='Lunas' order by bayar='250000' AND bayar='900000'");
				...
				<h3 style="text-align: right;">Total Pembayaran Lunas sebesar Rp. <?= number_format($total, 0, ',', '.'); ?></h3>
