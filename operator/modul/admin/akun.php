			...
			<div class="mt-5">
				<table>
									...
									<div class="modal-body">
										<form action="" method="POST">
											...
											<div class="form-group">
												...
												<input class="form-control" type="text" name="nama_user" value="<?= $adm['nama_lengkap']; ?>">
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label>Kontak</label>
												<select class="form-control" type="text" name="level" value="<?= $adm['status']; ?>">
											</div>
					...
					<tr>
						...
						<td>
							<h4 class="ml-2" style="color: green;"><?= $adm['kontak']; ?></h4>
						</td>
					</tr>
					<tr>
						<td></td>
