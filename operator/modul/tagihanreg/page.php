...
<div class="main-content mb-1">
  ...
  <div class="content-wrapper">
    <div class="content-header mr-2">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3 class="col-sm-6 ml-5">PEmbuatan Daftar Tagihan Register</h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="index.php?m=awal">Data Master</a></li>
            <li class="breadcrumb-item active">TAGIHAN REGISTRASI</li>
          </ol>
        </div><!-- /.col -->
      </div>
    </div>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="nominal" value="900000">
                </div>
              </div>
            ...
            <ul class="pagination justify-content-center">
              <li class="page-item">
                <a class="page-link" <?php if ($halaman > 1) {
                                        echo "href='?m=aktivan&halaman=$previous'";
                                      } ?>>Previous</a>
              </li>
              <?php
              for ($x = 1; $x <= $total_halaman; $x++) {
              ?>
                <li class="page-item"><a class="page-link" href="?m=aktivan&halaman=&nama_kelas=<?php echo $cari . $x ?>"><?php echo $x; ?></a></li>
              <?php
              }
              ?>
              <li class="page-item">
                <a class="page-link" <?php if ($halaman < $total_halaman) {
                                        echo "href='?m=aktivan&halaman=$next'";
                                      } ?>>Next</a>
              </li>
            </ul>
          </center>
