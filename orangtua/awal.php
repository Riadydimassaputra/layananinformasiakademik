...
<div class="page-content--bgf7">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>INFORMASI PEMBAYARAN BIAYA PENDIDIKAN</h3>
                <?php
                ...
                $siswa = mysqli_query($koneksi, "SELECT * from tagihan inner join siswa on tagihan.NIS=siswa.NIS inner join kelas on siswa.id_kls=kelas.id_kelas WHERE tagihan.NIS='$NIS' LIMIT 7");
                $result = array();
                while ($data = mysqli_fetch_array($siswa)) {
                    $result[] = $data; //result dijadikan array 
                }
            ...
            <div class="col-md-12">
                <br>
                <h2>Jadwal Pelajaran Anak anda</h2>
                <hr><br>
                <?php
                date_default_timezone_set("Asia/Jakarta");
                $waktu = date("d-m-Y");
