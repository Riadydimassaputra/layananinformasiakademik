<?php require '../fungsi_guru/fungsi.php'; ?>
<?php
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="has-sub">
                                    ...
                                    <ul class="header3-sub-list list-unstyled">
                                        <li>
                                            <a href="?m=input">Data Jadwal Mengajar <span class="bot-line"></span></a>
                                        </li>
                                        <li>
                                ...
                                <li class="has-sub">
                                    ...
                                    <ul class="header3-sub-list list-unstyled">
                                        <li>
                                            <a href="?m=laporan">Laporan Kehadiran Kegiatan<span class="bot-line"></span></a>
                                        </li>
                        ...
                        <ul class="navbar-mobile__list list-unstyled">
                            ...
                            <li class="has-sub">
                                ...
                                <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                    ...
                                    <li>
                                        <a href="?m=laporanguru">Data Laporan  <span class="bot-line"></span></a>
                                    </li>
